...
const RoutineDetails = () => {
    ...
    const { sidebar, setSidebar, isAdmin } = useStateContext(false);
    ...
    return (
        <>
            <div className={`bg-slate-200 md:m-0 w-[100vw] h-auto flex items-start justify-start ${sidebar ? 'p-0' : 'p-1'} lg:p-2 xl:p-4`}>
                ...
                <div className={`md:ml-[30vw] md:w-[67.5vw] lg:w-[70vw] p-8  rounded-xl ${sidebar && "opacity-0"}`}>
                    <div className="sm:p-8 p-4 rounded-2xl shadow-lg ">
                        ...
                        <div className="flex flex-col gap-4 text-lg sm:text-xl text-gray-800 main2">
