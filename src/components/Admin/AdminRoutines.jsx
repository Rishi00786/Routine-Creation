...
const AdminRoutines = () => {
  ...
  const { showRoutineBuilder, setShowRoutineBuilder } = useStateContext(false);
  ...
  return (
    <>
      {loading ? (
        ...
        <div className={`w-full p-4 min-h-screen ${showRoutineBuilder ? 'blur-lg opacity-50' : ''} bg-slate-200 flex flex-col items-center justify-start gap-8`}>
          <div
          ...
          <div className="w-full text-center md:p-8">
            ...
            {yourRoutines.length !== 0 ? (
              <div className="flex items-start justify-center md:justify-start gap-8 md:gap-12 lg:gap-12 flex-wrap">
                {yourRoutines.map((routine) => (
                  <Tilt
                    key={routine.id}
                    className="w-full sm:w-[30rem] md:w-[40vw] lg:max-w-[25rem] border border-green-300 rounded-2xl hover:shadow-xl hover:shadow-indigo-200 flex flex-col items-center bg-gradient-to-r from-purple-50 to-indigo-50 p-2"
                    tiltMaxAngleX={5}
                    tiltMaxAngleY={5}
                    perspective={1000}
                    scale={1.05}
      ...
      {loading ? (
        ...
        <div className={`w-full text-center p-2 lg:p-8 bg-slate-200 rounded-xl shadow-xl ${showRoutineBuilder ? 'blur-lg opacity-50' : ''}`}>
      ...
      {showRoutineBuilder && (
        ...
        <RoutineBuilder data={{}} isEdit={false} />
        // </div>
      )}
